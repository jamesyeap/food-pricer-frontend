...
import { searchFoodProduct } from '../../_redux/_actions/price.actions';
...
import FeedbackContainer from '../_organisms/FeedbackContainer';
...
export default function SearchPage(props: SearchPageProps) {
	...
	const LoadingScreen = () => {
		return (
			<View style={styles.animationContainer}>
				<LottieView 
					source={require('../../_assets/_lottieFiles/52102-searching.json')} 
					autoPlay 
					loop
					autoSize 
				/>
	...
	const StartingScreen = () => {
		return (
			<View style={styles.animationContainer}>
				<LottieView 
					source={require('../../_assets/_lottieFiles/55478-hello-bubble.json')} 
					autoPlay 
					loop
					autoSize
				/>
	...
	const EmptyScreen = () => {
		return (
			<View style={styles.animationContainer}>
				<LottieView 
					source={require('../../_assets/_lottieFiles/7903-error-404.json')} 
					autoPlay 
					loop
